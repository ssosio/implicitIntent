...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            case R.id.btnCall:
                intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:01050366335"));
                break;
            case R.id.btnDial:
                intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:01050366335"));
                break;
            case R.id.btnSms:
                intent = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto:01050366335"));
                break;
            case R.id.btnMap:
